...
public class simplexVersion {
    ...
    //Function 5: Calculating "min(Ratio)"
    ...
    //Function 6: Calculating "(index(min(Zj-CJ)))"
    ...
    //Function 7: Calculating "Key Column"
    ...
    //Function 8: Calculating "Key Row"
    ...
    //Function 9: Calculating "Key Element"
    ...
    //Function 10: Calculating "Key Row Dividing by Key Element also "b" "
    ...
    //Function 11: Calculating "Other Key Element"
    ...
    //Function 12: Operation (FINAL STEPS) "Multiply & Minus" 
    ...
    public static void main(String[] args) {
        ...
        //Dispalying: Initials
        System.out.println("Code By: psukhmeet\n");
        System.out.println("Welcome To Simplex Program\n(FOR: TWO EQUATIONS OF MAXIMIZATION PROBLESMS)");
        ...
        System.out.println("min(Zj-Cj): "+minOf_zj_minus_cj_Value);
            ...
            //Getting into Iterations:
                ...
                for(int i=0;minOf_zj_minus_cj_Value<0;i++){
                    ...
                    //Operation: "Table Multiply & Minus"
                    System.out.println();
                    ...
                    //Operation: "'b' Multiply & Minus"
                    System.out.println();
                    b = cal_b_mul_minus_b(rows, b, indexOf_minOf_minRAtio, other_Key_Element);              
                    System.out.println("Updating 'b' After Multiply & Minus");
                        for(int p=0;p<rows;p++){
                    ...
                    //Updating: Zj
                    zj = cal_Zj(columns, table, cb);
                    //System.out.println("Updated Zj: ");
                        // for(int r=0;r<columns;r++){
                        //     System.out.print(zj[r]+" ");
                        // }
